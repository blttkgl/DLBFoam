...
#include "pyjacChemistryTabulationMethod.H"
#include "Time.H"
#include "noPyjacChemistryTabulation.H"

// * * * * * * * * * * * * * * * * Selectors * * * * * * * * * * * * * * * * //

Foam::autoPtr<Foam::pyjacChemistryTabulationMethod>
Foam::pyjacChemistryTabulationMethod::New
(
...
)
{
    if (dict.found("tabulation"))
    {
        ...
        return autoPtr<pyjacChemistryTabulationMethod>
        (
    ...
    else
    {
        return autoPtr<pyjacChemistryTabulationMethod>
        (
            new pyjacChemistryTabulationMethods::none(dict, chemistry)
        );
    }
}
